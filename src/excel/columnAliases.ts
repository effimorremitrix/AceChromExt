...
export const COLUMN_SPECS: ColumnSpec[] = [
  ...
  { column: 'InvoiceDate', aliases: ['invoicedate', 'date', 'exportdate', 'dateofexport', 'estimatedexportdate', 'departuredate'], kind: 'date', target: 'invoice', field: 'invoiceDate' },
  { column: 'BillTo', aliases: ['billto', 'billtoaddress', 'billingaddress', 'consigneeaddress', 'address', 'addressline1', 'address1', 'billtoaddress1', 'consigneeaddress1'], kind: 'text', target: 'invoice', field: 'billTo' },
  { column: 'BillToAddress2', aliases: ['billtoaddress2', 'addressline2', 'address2', 'consigneeaddress2', 'billto2'], kind: 'text', target: 'invoice', field: 'billToAddress2' },
