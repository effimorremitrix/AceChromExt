...
const INSTRUCTIONS = [
  ...
  ['CustomerName', 'Ultimate consignee name.'],
  ['InvoiceNumber', 'Becomes the ACE shipment reference (17 characters maximum).'],
  ['InvoiceDate', 'YYYY-MM-DD, MM/DD/YYYY, or a real Excel date. Filed as MM/DD/YYYY.'],
  ['BillTo', 'Consignee address.'],
  ['FreightTerms', 'INCO terms / terms of sale, e.g. CIF, FOB.'],
  ['PaymentTerms / PaymentDueDate', 'Carried for reference and for the future QuickBooks phase; not filed in AES.'],
  ['PONumber', 'Customer purchase order.'],
  ...
  ['Destination', 'Country of ultimate destination, ISO 3166-1 alpha-2 (IL, CA, DE). Common country names are converted.'],
  ['', ''],
